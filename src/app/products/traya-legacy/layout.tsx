...
export const metadata: Metadata = {
    title: "Traya Legacy",
    description:
        "Explore our collection of Traya Legacy cookware, handcrafted for culinary excellence. Discover the perfect blend of tradition and innovation in cookware.",
    keywords: [
        "Rasa Cookware",
