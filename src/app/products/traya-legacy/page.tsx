                ...
                <div className="relative z-10 text-center items-center justify-center px-6">
                    ...
                    <TextLift delay={0.4}>
                        <p className="text-lg md:text-xl max-w-2xl mx-auto mt-4 font-cormorant text-zinc-200 drop-shadow-sm">
                            ...
                            elegance with our Traya Legacy cookware collection.
                            Crafted for those who appreciate the art of cooking,
                            these triply stainless steel pieces are designed to
